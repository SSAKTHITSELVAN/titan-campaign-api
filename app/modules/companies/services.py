...
class CompanyService:
    ...
    def get_company(self, company_id: int, current_employee: Employee = None) -> CompanyResponse:
        """Get company details"""
    ...
    def get_company_stats(self, company_id: int, current_employee: Employee) -> CompanyStats:
